...
- 🔧 **零設定安裝** - 一行指令完成所有設定
- 🎯 **智慧選擇** - 預設安裝常用語言，也可自訂組合
- ♻️ **冪等性** - 重複執行安全，已安裝的工具自動跳過
- 🚀 **mise 驅動** - 使用 [mise](https://mise.jdx.dev) 管理開發工具版本
- 📦 **完整工具鏈** - 包含 Homebrew、Git、Ripgrep、fzf 等開發必備工具
...
|------|------|------|
| `python` | Python | 最新穩定版 |
| `elixir` | Elixir + Erlang | 此選項會同時安裝對應的 Erlang 版本 |
...
> 💡 **提示**: Erlang 和 Rust 需要從原始碼編譯，首次安裝較慢。後續版本更新會使用預編譯版本，速度較快。
...
- [段取り (dandori) 的由來](https://en.wikipedia.org/wiki/Mise_en_place) - 與法式料理的 "mise en place" 異曲同工

---

**dandori** - 為你的開發環境做好段取り 🎯
